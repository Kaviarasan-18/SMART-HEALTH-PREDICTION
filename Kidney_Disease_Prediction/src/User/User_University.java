...
public class User_University extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String admtype1=request.getParameter("db_admtype1");
		String admtype2=request.getParameter("db_admtype2");
		String admtype3=request.getParameter("db_admtype3");
		...
		db.setannual_income1(admtype1);
		db.setannual_income2(admtype2);
		db.setannual_income3(admtype3);
		...
		if(status==1)
		{
			response.sendRedirect("KB_Test.jsp");
		}
		else
		{
