...
<body style="background:#a5a5c0;">
 ...
 <!-- ################# Header Starts Here#######################--->
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li  class="active"><a href="Urine_Test.jsp"><i class="notika-icon notika-app"></i> Urine Test</a>
                        </li>
    ...
    <div class="form-element-area">
        <div class="container">
                    <form method="Post" action="User_Psycho">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <select name="db_fstress" class="selectpicker">
											<option>Hypertension(HYT)</option>
											<option>Yes</option>
											<option>No</option>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                    <div class="bootstrap-select fm-cmp-mg">
                                    <select name="db_univstress" class="selectpicker">
											<option>Diabetes Mellitus(DM)</option>
											<option>Yes</option>
											<option>No</option>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                             <div class="bootstrap-select fm-cmp-mg">
                                    <select name="db_shr" class="selectpicker">
                         ...
                         <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                                                 <div class="bootstrap-select fm-cmp-mg">
                                    <select name="db_sochr" class="selectpicker">
											<option>Appetite(appet)</option>
										    <option>Good</option>
											<option>Poor</option>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                                                 <div class="bootstrap-select fm-cmp-mg">
                                    <select name="db_mobhr" class="selectpicker">
											<option>Pedal Edema(pe)</option>
											<option>Yes</option>
											<option>No</option>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                    <div class="bootstrap-select fm-cmp-mg">
                                    <select name="db_eyeprblm" class="selectpicker">
											<option>Anemia(ane)</option>
											<option>Yes</option>
											<option>No</option>
                         ...
                         <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                    <div class="bootstrap-select fm-cmp-mg">
                                    <select name="db_dropout" class="selectpicker">
