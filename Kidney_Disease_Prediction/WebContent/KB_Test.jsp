...
<!-- ################# Header Starts Here#######################--->
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="active"><a href="KB_Test.jsp"><i class="notika-icon notika-form"></i> Kidney Biopsy Test</a>
                        </li>
    ...
    <div class="form-element-area">
        <div class="container">
            <form method="Post" action="User_Curricular">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">

                        <div class="cmp-tb-hd bcs-hd">
                            <h2>Cells Count Test</h2>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                   ...
                                   <div class="bootstrap-select fm-cmp-mg">
                                    <select name="db_ecurri" class="selectpicker">
											<option>Packed cell volume(PCV)</option>
											<option>0.36</option>
											<option>0.48</option>
											<option>0.95</option>
											<option>1.48</option>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                    <div class="bootstrap-select fm-cmp-mg">
                                    <select name="db_cocurri" class="selectpicker">
											<option>White Blood Cells Count(WC)</option>
											<option>3000 cells/cumm</option>
											<option>3500 cells/cumm</option>
											<option>4500 cells/cumm</option>
											<option>7000 cells/cumm</option>
											<option>11000 cells/cumm</option>
										</select>
                                </div>
                                    </div>
                                    <div class="form-ic-cmp">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                    <div class="bootstrap-select fm-cmp-mg">
                                    <select name="db_conf" class="selectpicker">
											<option>Red Blood Cells Count(RC) </option>
											<option>4.20 millions/cmm</option>
											<option>4.35 millions/cmm</option>
											<option>5.15 millions/cmm</option>
											<option>5.65 millions/cmm</option>
