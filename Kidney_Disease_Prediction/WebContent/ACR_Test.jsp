...
<body style="background:#a5a5c0;">
  ...
  <!-- ################# Header Starts Here#######################--->
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="active"><a href="ACR_Test.jsp"><i class="notika-icon notika-edit"></i> Albumin-to-creatinine Ratio Test</a>
                        </li>
    ...
    <div class="form-element-area">
        <div class="container">
         <form method="Post" action="User_School">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <select name="db_ssc" class="selectpicker">
											<option>Blood Pressure</option>
											<option>120/80 mmHg</option>
											<option>130/80 mmHg</option>
											<option>135/85 mmHg</option>
											<option>140/90 mmHg</option>
											<option>150/100 mmHg</option>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <div class="bootstrap-select fm-cmp-mg">
                                    <select name="db_hsc" class="selectpicker">
											<option>Specific Gravity(sg)</option>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                       <div class="bootstrap-select fm-cmp-mg">
                                    <select name="db_medium" class="selectpicker">
											<option>Select Albumin(al)</option>
											<option>0</option>
											<option>1</option>
											<option>2</option>
											<option>3</option>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                                                        <div class="bootstrap-select fm-cmp-mg">
                                    <select name="db_loc" class="selectpicker">
											<option>Select Sugar(su)</option>
											<option>0</option>
											<option>1</option>
											<option>2</option>
											<option>3</option>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                                           <div class="bootstrap-select fm-cmp-mg">
                                    <select name="db_stream" class="selectpicker">
											<option>Red blood cells(rbc)</option>
