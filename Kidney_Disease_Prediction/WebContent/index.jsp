...
<head>
    ...
    <!-- Font Icon -->
    <link rel="stylesheet" href="rfonts/material-icon/css/material-design-iconic-font.min.css">
        ...
        <div class="container">
            <div class="signup-content">
                <div class="signup-img">
                    <img src="rimages/patient.png" alt="">
                </div>
                    ...
                    <form method="POST" action="User_Register" class="register-form" id="register-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="lpass" id="name" required/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="lcpass" id="name" required/>
                            </div>
